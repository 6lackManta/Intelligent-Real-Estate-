...
@section('content')    <!-- ============================================================== -->
    ...
    <a href="javascript:void(0)"><img src= "{{ url('backend/plugins/images/users/genu.jpg') }}" 
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div class="white-box">
<form class="form-horizontal form-material" enctype="multipart/form-data" method="POST" action="{{route('contractor.profile.store')}}">
                                @csrf
                                  <div class="form-group">
                                    <label class="col-md-12">ID</label>
                                    <div class="col-md-12">
   <input type="text"name="id" class="form-control form-control-line" readonly value="{{Auth::guard('contractor')->user()->id}}" > </div>
                                </div>
