...
@section('content')    <!-- ============================================================== -->
    ...
    <a href="javascript:void(0)"><img src= "{{ url('backend/plugins/images/users/genu.jpg') }}" 
                                        ...
                                        <h4 class="text-white">{{Auth::guard('contractor')->user()->name}}</h4>
                                        <h5 class="text-white">{{Auth::guard('contractor')->user()->email}}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="user-btm-box">
                                <div class="col-md-4 col-sm-4 text-center">
                                    ...
                                    <div class="col-sm-12">
                                        <a class="button btn btn-danger" style="color: white" href="{{ route('contractor.profile.create') }}">Edit Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                 ...
                                 `
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" disabled 
                                           value="{{-- {{$contractor->name}} --}}" class="form-control form-control-line"></div>
                                </div>
