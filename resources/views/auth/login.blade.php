            ...
            <form method="POST" action="{{ route('login') }}">
               ...
               <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required >
                   ...
                   <div> <input type="submit" value="Login">
                     <a style="color: white" class="acount-btn" href="{{ route("login.github") }}"><i class="fa fa-github fa-lg"></i>  Login with Github </a> 
                     <a style="color: white" class="acount-btn" href="{{ route("login.github") }}"><i class="fa fa-google fa-lg"></i>  Login with Google </a></div>
