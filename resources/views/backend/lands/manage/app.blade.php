...
<head>
    ...
    <link rel="icon" type="{{asset('backend/image/png') }}" sizes="16x16" href="backend/plugins/images/favicon.png">
    <title>CMS-Realestate</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
 ...
 @include('backend.lands.manage.partials.scripts')
</body>
