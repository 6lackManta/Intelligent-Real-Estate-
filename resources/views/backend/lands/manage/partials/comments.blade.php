                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center p-t-10">
                                <div class="comment-body">
                                    <div class="user-img"> <img src="{{url('backend/plugins/images/users/pawandeep.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                ...
                                <div class="comment-body">
                                    <div class="user-img"> <img src="{{url('backend/plugins/images/users/sonu.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
                                ...
                                <div class="comment-body b-none">
                                    <div class="user-img"> <img src="{{url('backend/plugins/images/users/arijit.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
